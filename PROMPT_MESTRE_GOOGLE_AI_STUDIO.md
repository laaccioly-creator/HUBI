...
1. **`lojas`**: `id`, `nome_fantasia`, `razao_social`, `tipo_documento`, `numero_documento`, `telefone`, `whatsapp`, `email`, `slug_catalogo`, `cor_primaria`, `sobre_loja`, `valor_minimo_pedido`, `tipo_plano`, `desconto_padrao_atacado_percentual`, `desconto_padrao_autoatacado_percentual`, `configuracoes_extras` (JSONB com taxas de venda, status de pedidos ativos, recibo personalizado, entrega/retirada, preferências gerais), `criado_em`.
2. **`usuarios_loja`**: `id`, `loja_id`, `usuario_auth_id`, `nome_completo`, `email`, `perfil` ('owner', 'admin', 'gerente', 'vendedor', 'comum'), `pode_ver_preco_custo`, `pode_exportar_relatorios`, `pode_editar_vendas_passadas`, `pode_cadastrar_alterar_produtos`, `pode_gerenciar_estoque`, `pode_ativar_fiado`, `ativo`.
...
5. **`produtos`**: `id`, `loja_id`, `categoria_id`, `fornecedor_id`, `nome`, `codigo_interno`, `codigo_barras`, `descricao`, `fotos_urls` (JSONB), `tipo_unidade` ('un', 'kg', 'l', 'm'), `preco_custo`, `preco_venda_varejo`, `preco_venda_atacado`, `qtd_minima_atacado`, `preco_venda_autoatacado`, `qtd_minima_autoatacado`, `preco_promocional`, `promocao_ativa`, `quantidade_estoque` (sincronizado automaticamente com a soma das variações), `estoque_minimo_alerta`, `tem_variacoes`, `rotulo_variacao_1`, `rotulo_variacao_2`, `eh_combo`, `data_validade`, `exibir_catalogo`, `destaque`, `ativo`.
6. **`variacoes_produto`**: `id`, `loja_id`, `produto_id`, `valor_variacao_1`, `valor_variacao_2`, `sku`, `codigo_barras`, `preco_custo`, `preco_venda_varejo`, `preco_venda_atacado`, `preco_venda_autoatacado`, `preco_promocional`, `quantidade_estoque` (controle de estoque físico por grade individual), `estoque_minimo_alerta`, `ativo`.
...
9. **`formas_pagamento`**: `id`, `loja_id`, `nome`, `tipo` ('dinheiro', 'pix', 'cartao_credito', 'cartao_debito', 'fiado', 'outro'), `taxa_percentual`, `taxa_fixa`, `maximo_parcelas`, `descricao` (instruções/chave PIX), `ativo`, `exibir_catalogo`.
