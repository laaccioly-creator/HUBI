...
CREATE TABLE IF NOT EXISTS public.lojas (
    ...
    tipo_minimo_padrao_atacado VARCHAR(20) DEFAULT 'hibrido',
    qtd_minima_padrao_atacado NUMERIC(12,2) DEFAULT 50.00,
    qtd_minima_sku_padrao_atacado NUMERIC(12,2) DEFAULT 6.00,
    valor_minimo_padrao_atacado NUMERIC(12,2) DEFAULT 1500.00,
    desconto_padrao_autoatacado_percentual NUMERIC(5,2) DEFAULT 25.00,
    tipo_minimo_padrao_autoatacado VARCHAR(20) DEFAULT 'hibrido',
