-- ==============================================================================
-- MIGRATION: 20260924_tabelas_logistica_manual.sql
-- Módulo de Logística Manual: Cadastros Relacionais de Apps de Corrida e Transportadoras
-- ==============================================================================
...
-- 2. TABELA public.transportadoras (Cadastro Completo de Relacionamento e Rastreio)
...
-- 3. VÍNCULOS RELACIONAIS EM public.pedido_entregas E public.pedidos
...
CREATE INDEX IF NOT EXISTS idx_pedido_entregas_app_entrega_id 
  ON public.pedido_entregas(app_entrega_id);


-- 4. SEEDS DEFENSIVOS PARA TODAS AS LOJAS EXISTENTES
...
-- Transportadoras Padrão com Templates de Rastreio
